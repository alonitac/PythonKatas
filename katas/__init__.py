katas = [
    ...
    'my_abs.py',                        # abs (abs without abs)
    'shopping_list.py',                 # intro list
    'last_one.py',                      # simple element choose in list
    'sandwich_ingredients.py',          # simple slice
    'every_second_word.py',             # slice with jumps
    'recent_messages.py',               # slice to ends
    'get_username.py',                  # slice of string
    'shopping_list2.py',                # add to list
    'log_message.py',                   # Print vs return (func return None)
    '',                                 # default values arguments
    'mailing_list.py',                  # two functions: concat strings and split
    'grader.py',                        # multiple returns in function
    'find_student.py',                  # in operator (list, string)
    'is_word_absent.py',                # not in
    'is_valid_password',                # len built in function
    'is_earlier.py',                    # compare two lists
    'num_of_digits.py',                 # total digits (int to str conversion)
    'is_palindrome.py',                 # reverse string
    'has_pattern.py',                   # slice in if
    'is_subscriber_matching.py'         # Compare case-insensitive values (str.lower())
    'get_first_n_words.py',             # str: split, join
    'clean_text.py',                    # str: replace
    'get_user_info.py'                  # tuple, return multiple values
    'fraction_of_float.py'              # type convertion: float-int or float-str
    'start_end.py'                      # slice, str, check user input
    'verbing.py'                        # str endswith
    'print_list_elements.py'            # for loop simple 
    ...
    'in_the_club.py'                    # eligible enter the club (id or passport and above 18)
    'top_student.py'                    # lambda in `max` function 
    'mind_the_gap.py'                   # manually count spaces in string (str.count())
    'is_sublist.py'                     # sublist check
    'runner_position.py'                # find the index (list.index(), but do it manually)
    'folder_count.py'                   # get filename by path check valid path
    'secret_club.py'                    # dict from two lists
    'alex_has_ocd.py'                   # list of tuples from dict
